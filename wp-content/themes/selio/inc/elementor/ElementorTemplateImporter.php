...
class Elementor_Template_Importer {
    ...
    public function __construct( $templates, $args )
    {
        ...
        if( !class_exists( 'Elementor\Plugin' ) ) {
            return new WP_Error( 'elementor-not-activated', esc_html__( 'Elementor is not activated.', 'selio' ) );
        }
    ...
    public function import_template( $url )
    {
        ...
        if( !empty($_FILES) ) {
            return new WP_Error( 'elementor-template-global-not-empty', esc_html__( 'Seems the $_FILE global already has a file and I do not wanna conflict.', 'selio' ) );
        }
    ...
    public function template_exists( $template_name )
    {
        ...
        return new WP_Error( 'elementor-template-already-loaded', esc_html__( 'This template has already been loaded.', 'selio' ) );
    }
