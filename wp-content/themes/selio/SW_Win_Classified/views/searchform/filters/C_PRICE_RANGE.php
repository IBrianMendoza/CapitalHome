...
<div class=" <?php echo esc_attr($class_add); ?>">
    <div class="form-group">
        <div class="scale-range" id="nonlinear-price">
            ...
            <div class="scale-range-value">
                <span class="scale-range-label"><?php echo esc_html__('Price Range','selio');?></span>
                <?php echo esc_html__('from','selio');?>
                <span class="nonlinear-min"></span>
                <?php echo esc_html__('to','selio');?>
