...
<div id="sw_map_results" data-zoom_index="<?php echo esc_attr($zoom_index); ?>" data-num_listings="<?php echo esc_attr($num_listings); ?>" ></div>
...
?>
<?php if(!selio_plugin_call::sw_settings('open_street_map_enabled')):?>
<?php wp_enqueue_script( 'google-markerclusterers' ); ?>
<?php wp_enqueue_script( 'selio-custom-marker' ); ?>
<?php endif;?>
        ...
        var callback = {
                    'click': function(map, e){
                        ...
                        var boxOptions = {
                            ...
                            alignBottom: true,
                            maxWidth: 0,
                            pixelOffset: new google.maps.Size(-68, -25),
                            zIndex: null,
