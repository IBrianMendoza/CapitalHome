...
/*
Plugin Name: Winter Classified SVG Geo maps
Plugin URI: http://codecanyon.net/user/sanljiljan
Description: Addon for GEO Region map on classified portal
Author: Sandi Winter
...
define( 'SW_WIN_GEOMAP_PLUGIN_PATH', plugin_dir_path( __FILE__ ) );

function show_geomap()
{
    
}

add_action( 'plugins_loaded', 'sw_pluginsLoaded_geomap' );

function sw_pluginsLoaded_geomap() {
	// Setup locale
