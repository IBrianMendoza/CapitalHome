...
/*
Plugin Name: Winter Classified Calendar
Plugin URI: http://codecanyon.net/user/sanljiljan
Description: Addon for Calendar on classified portal
Author: Sandi Winter
...
define( 'SW_WIN_CALENDAR_PLUGIN_PATH', plugin_dir_path( __FILE__ ) );

function sw_win_load_ci_function_calendar($callback) 
{

}

add_action( 'plugins_loaded', 'sw_pluginsLoaded_calendar' );

function sw_pluginsLoaded_calendar() {
	// Setup locale
