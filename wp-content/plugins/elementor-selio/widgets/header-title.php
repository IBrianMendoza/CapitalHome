 ...
 * @since 1.1.0
 */
class Header_Title extends Widget_Base {
	...
	private $defaults = array(
		array(
			'page_title' => 'Features Example',
			'background_color' => '#eeeef0',
		),
		array(
			'enable_image_version' => 'no',
			'enable_mask' => 'yes',
			'mask_image' => '',
		),
	);
	...
	public function get_title() {
		return __( 'Header Title', 'selio-blocks' );
	}
	...
	protected function render() {
		...
		*/
		...
		if ( empty( $settings['item_2_mask_image']['id'] ) ) {
			$settings['item_2_mask_image']['url'] = SELIO_THEMEROOT.'/assets/images/resources/pager-bg.jpg';
		}
...
<?php if($settings['item_2_enable_image_version'] == 'yes'): ?>

<section class="pager-sec bfr <?php if($settings['item_2_enable_mask'] == 'no'): ?>no-mask<?php endif;?>" style="background-image: url(<?php echo $settings['item_2_mask_image']['url']; ?>);">
	<div class="container">
		<div class="pager-sec-details">
			<h3 <?php echo $this->get_render_attribute_string( 'item_1_page_title' ); ?>><?php echo $settings['item_1_page_title']; ?></h3>
...
<section class="pager-sec st2" style="background-color: <?php echo $settings['item_1_background_color']; ?>;">
	<div class="container">
		<div class="pager-sec-details">
			<h3 <?php echo $this->get_render_attribute_string( 'item_1_page_title' ); ?>><?php echo $settings['item_1_page_title']; ?></h3>
                        <?php selio_the_selio_breadcrumb(); ?>
