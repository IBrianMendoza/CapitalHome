 ...
 * @since 1.1.0
 */
class Wide_Search extends Widget_Base {
	...
	public function get_title() {
		return __( 'Wide Search', 'selio-blocks' );
	}
...
<h2 class="vis-hid"><?php echo esc_html__('Wide search elementor','selio-blocks');?></h2>
<section class="form-banner wide-search">
	<h3 class="vis-hid"><?php echo esc_html__('Invisible Heading', 'selio-blocks');?></h3>
	<div class="banner_form" <?php if($settings['item_1_background_color'] != '#d8d8d9'): ?>style="background-color: <?php echo $settings['item_1_background_color']; ?>;"<?php endif;?>>
		<div class="container">
