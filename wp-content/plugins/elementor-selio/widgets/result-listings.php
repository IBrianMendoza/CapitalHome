 ...
 * @since 1.1.0
 */
class Result_Listings extends Widget_Base {
	...
	private $defaults = array(
		array(
			'default_view_dropdown' => 'grid,list',
                        'zebra_enable' => '',
	...
	public function get_title() {
		return __( 'Result Listings', 'selio-blocks' );
	}
	...
	protected function _register_controls() {
		...
		for($i=0;$i<$this->items_num;$i++)
		{
			...
			foreach($item_elements as $key=>$val)
			{
				...
				elseif(substr_count($key, 'dropdown') > 0)
				{
	...
	protected function render() {
		...
		$content = "";
                ...
                $selio_default_view = $settings['item_1_default_view_dropdown'];
		sw_win_load_ci_function('Frontend', 'resultspage', array(&$content));

		echo $content;

		?>
<h2 class="vis-hid"><?php echo esc_html__('Results elementor','selio-blocks');?></h2>
