 ...
 * @since 1.1.0
 */
class Carousel_Purposes extends Widget_Base {
	...
	private $defaults = array(
		array(
			'mini_title' => 'Explore Features',
			'big_title' => 'Service You Need',
                        'zebra_enable' => '',
			'elementor_custom_padding_enable' => '',
		),
		array(
			'slider_image' => '',
			'slider_icon' => 'la la-play',
			'link' => '#',
	...
	public function get_title() {
		return __( 'Carousel Purposes', 'selio-blocks' );
	}
	...
	protected function render() {
		...
		if ( empty( $settings['item_4_slider_image']['id'] ) ) {
			$settings['item_4_slider_image']['url'] = SELIO_THEMEROOT.'/assets/images/carousel/carousel-1.jpg';
		}
		
		if ( empty( $settings['item_2_slider_image']['id'] ) ) {
			$settings['item_2_slider_image']['url'] = SELIO_THEMEROOT.'/assets/images/carousel/carousel-2.jpg';
		}
		
		if ( empty( $settings['item_3_slider_image']['id'] ) ) {
			$settings['item_3_slider_image']['url'] = SELIO_THEMEROOT.'/assets/images/carousel/carousel-3.jpg';
		}
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-xl-6">
                ...
                <div class="ui-card-slider-box">
                    <div id="slider" class="ui-card-slider">
                        <?php for($i=2;$i<$this->items_num+1;$i++): ?>
                        <?php if(!empty($settings['item_'.$i.'_slider_image']['url'])): ?>
                                <?php if($settings['item_'.$i.'_video_popup_enable'] == 'yes') :?>
                                    <div class="slide">
                                        <div class="scontent">
                                            <i class="la la-play slide-icon"></i>
                                            <h2 <?php echo $this->get_render_attribute_string( 'item_'.$i.'_title' ); ?>><?php echo $settings['item_'.$i.'_title']; ?></h2>
                                        </div>
                                        <img src="<?php echo $settings['item_'.$i.'_slider_image']['url']; ?>" alt="<?php echo $settings['item_'.$i.'_title']; ?>">
                                        <a href="<?php echo $settings['item_'.$i.'_link']; ?>" class='html5lightbox link-ext'></a>
                                    </div>
                                <?php else:?>
                                    <div class="slide">
                                        <div class="scontent">
                                            <i class="<?php echo $settings['item_'.$i.'_slider_icon']; ?> slide-icon"></i>
                                            <h2 <?php echo $this->get_render_attribute_string( 'item_'.$i.'_title' ); ?>><?php echo $settings['item_'.$i.'_title']; ?></h2>
                                        </div>
                                        <img src="<?php echo $settings['item_'.$i.'_slider_image']['url']; ?>" alt="<?php echo $settings['item_'.$i.'_title']; ?>">
                                        <a href="<?php echo $settings['item_'.$i.'_link']; ?>" class='link-ext'></a>
                                    </div>
                                <?php endif; ?>
                        <?php endif; ?>
                        <?php endfor; ?>
                    </div>
                    <div class="ui-card-slider-nav">
                        <a href="" class="arrow left"><i class="la la-arrow-left"></i></a>
                        <a href="" class="arrow right"><i class="la la-arrow-right"></i></a>
                    </div>
                </div>
	</div>
</section>
