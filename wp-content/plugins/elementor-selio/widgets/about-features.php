 ...
 * @since 1.1.0
 */
class About_Features extends Widget_Base {
	...
	private $defaults = array(
		...
		array(
			'service_icon' => 'la la-home',
			'service_title' => 'Perfect Tools',
			'service_link' => '#',
			'service_description' => 'Aenean sollicitudin, lorem quis bibendum auctor, nisi elit conseat ipsum, nec sagittis sem nibh.',
		),
		array(
			'service_icon' => 'icon-cursor',
			'service_title' => 'Search In Click',
			'service_link' => '#',
			'service_description' => 'Aenean sollicitudin, lorem quis bibendum auctor, nisi elit conseat ipsum, nec sagittis sem nibh.',
		),
		array(
			'service_icon' => 'icon-lock',
			'service_title' => 'User Control',
			'service_link' => '#',
			'service_description' => 'Aenean sollicitudin, lorem quis bibendum auctor, nisi elit conseat ipsum, nec sagittis sem nibh.',
		),
	);
	...
	public function get_title() {
		return __( 'About Features', 'selio-blocks' );
	}
	...
	protected function render() {
		...
		*/
		...
		if ( empty( $settings['item_1_background_image']['id'] ) ) {
			$settings['item_1_background_image']['url'] = SELIO_THEMEROOT.'/assets/images/placeholder-about.png';
		}
...
<section class="sec-about-features section-padding <?php if($settings['item_1_zebra_enable']=='yes'):?> zebra-section<?php endif;?> <?php if($settings['item_1_elementor_custom_padding_enable']=='yes'):?> no-padding<?php endif;?>">
	<div class="container">
		<div class="row justify-content-center">
            ...
            <div class="content-about">
                <?php for($i=1;$i<$this->items_num+1;$i++): ?>
                    <?php if(!empty($settings['item_'.$i.'_service_title'])): ?>
                        <div class="item">
                            <div class="icon"><i class="<?php echo $settings['item_'.$i.'_service_icon']; ?>"></i></div>
                            <div class="body">
                                <h3 <?php echo $this->get_render_attribute_string( 'item_'.$i.'_service_title' ); ?>><?php echo $settings['item_'.$i.'_service_title']; ?></h3>
                                <div <?php echo $this->get_render_attribute_string( 'item_'.$i.'_service_description' ); ?>><?php echo $settings['item_'.$i.'_service_description']; ?></div>
                            </div>
                        </div>
                    <?php endif; ?>
                <?php endfor; ?>
            </div>
            <img src="<?php echo esc_url($settings['item_1_background_image']['url']);?>" alt="" class="cover-sec-about-features">
	</div>
</section>
