 ...
 * @since 1.1.0
 */
class Services_You_Need extends Widget_Base {
	...
	public function get_title() {
		return __( 'Services You Need', 'selio-blocks' );
	}
...
<section class="explore-feature hp_s1 section-padding section-services-you-need <?php if($settings['item_1_zebra_enable']=='yes'):?> zebra-section<?php endif;?> <?php if($settings['item_1_elementor_custom_padding_enable']=='yes'):?> no-padding<?php endif;?>">
	<div class="container">
...
<?php if(!empty($settings['item_'.$i.'_service_title'])): ?>
        <?php if(!empty($settings['item_5_service_title'])): ?>            
	<div class="col-xl-3 col-sm-6 col-md-6 col-lg-4">
        <?php else:?>
	<div class="col-xl-4 col-sm-6 col-md-6 col-lg-4">
        <?php endif;?>
		<a href="<?php echo $settings['item_'.$i.'_service_link']; ?>" title="">
			<div class="card">
				<div class="card-body">
					<i class="<?php echo $settings['item_'.$i.'_service_icon']; ?>"></i>
					<h3 <?php echo $this->get_render_attribute_string( 'item_'.$i.'_service_title' ); ?>><?php echo $settings['item_'.$i.'_service_title']; ?></h3>
					<p <?php echo $this->get_render_attribute_string( 'item_'.$i.'_service_description' ); ?>><?php echo $settings['item_'.$i.'_service_description']; ?></p>
				</div>
			</div><!--card end-->
		</a>
	</div>
