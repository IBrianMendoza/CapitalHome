...
class Admin extends App {
	...
	public function plugin_row_meta( $plugin_meta, $plugin_file ) {
		if ( ELEMENTOR_PLUGIN_BASE === $plugin_file ) {
			$row_meta = [
				'docs' => '<a href="https://go.elementor.com/docs-admin-plugins/?ref=5670" aria-label="' . esc_attr( __( 'View Elementor Documentation', 'elementor' ) ) . '" target="_blank">' . __( 'Docs & FAQs', 'elementor' ) . '</a>',
				'ideo' => '<a href="https://go.elementor.com/yt-admin-plugins/?ref=5670" aria-label="' . esc_attr( __( 'View Elementor Video Tutorials', 'elementor' ) ) . '" target="_blank">' . __( 'Video Tutorials', 'elementor' ) . '</a>',
			];
	...
	public function admin_footer_text( $footer_text ) {
		...
		if ( $is_elementor_screen ) {
			$footer_text = sprintf(
				...
				'<a href="https://go.elementor.com/admin-review/?ref=5670" target="_blank">&#9733;&#9733;&#9733;&#9733;&#9733;</a>'
			);
		}
	...
	private function get_dashboard_overview_widget_footer_actions() {
		$base_actions = [
			'blog' => [
				...
				'link' => 'https://go.elementor.com/overview-widget-blog/?ref=5670',
			],
			'help' => [
				'title' => __( 'Help', 'elementor' ),
				'link' => 'https://go.elementor.com/overview-widget-docs/?ref=5670',
			],
		];
