...
class Settings extends Settings_Page {
	...
	public function handle_external_redirects() {
		...
		if ( 'go_knowledge_base_site' === $_GET['page'] ) {
			wp_redirect( 'https://go.elementor.com/docs-admin-menu/?ref=5670' );
			die;
		}
	}
				...
				<div class="e-getting-started__box postbox">
					...
					<div class="e-getting-started__content">
						...
						<div class="e-getting-started__actions e-getting-started__content--narrow">
							...
							<a href="https://go.elementor.com/getting-started/?ref=5670" target="_blank" class="button button-secondary button-hero"><?php echo __( 'Get the Full Guide', 'elementor' ); ?></a>
						</div>
					</div>
				</div>
			</div>
						...
						'fields' => [
							'allow_tracking' => [
								...
								'field_args' => [
									...
									'value' => 'yes',
									'default' => '',
									'sub_desc' => __( 'Opt-in to our anonymous plugin data collection and to updates. We guarantee no sensitive data is collected.', 'elementor' ) . sprintf( ' <a href="%1$s" target="_blank">%2$s</a>', 'https://go.elementor.com/usage-data-tracking/?ref=5670', __( 'Learn more.', 'elementor' ) ),
								],
