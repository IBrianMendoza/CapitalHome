...
<h1><?php echo __('Calendar reservations','sw_win'); ?> <a href="<?php menu_page_url( 'calendars_reservations', true ); ?>&function=addreservation" class="page-title-action"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo __('Add New','sw_win')?></a>
</h1>
	...
	if ($('#din-table').length) {
		...
		var table = $('#din-table').DataTable({
            ...
            'ajax': {
                ...
                "data": function ( d ) {
                    return $.extend( {}, d, {
                        "page": 'calendars_datatablereservation',
                        "action": 'ci_action'
                    } );
                }
            },
