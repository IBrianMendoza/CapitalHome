...
<a href="<?php menu_page_url( 'calendars_manage', true ); ?>&function=addcalendar" class="page-title-action"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo __('Add New','sw_win')?></a>
</h1>
