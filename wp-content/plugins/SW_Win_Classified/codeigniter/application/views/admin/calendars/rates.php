...
<h1><?php echo __('Calendar rates','sw_win'); ?> <a href="<?php menu_page_url( 'calendars_rates', true ); ?>&function=addrate" class="page-title-action"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo __('Add New','sw_win')?></a>
</h1>
