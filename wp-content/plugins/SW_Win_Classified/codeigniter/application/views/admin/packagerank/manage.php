...
<h1><?php echo __('Rank package manage','sw_win'); ?> 
<a href="<?php menu_page_url( 'packagerank_manage', true ); ?>&function=addpackagerank" class="page-title-action"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo __('Add New','sw_win')?></a>
</h1>
		...
		<table id="din-table" class="table table-striped" style="width: 100%;">
			<thead>
				<tr>
					...
					<th data-priority="4"><?php echo __('Package name', 'sw_win'); ?></th>
					<th data-priority="2"><?php echo __('Rank', 'sw_win'); ?></th>
			...
			<tfoot>
				<tr>
					...
					<th><input type="text" placeholder="<?php echo __('Package name', 'sw_win'); ?>" /></th>
                    <th><input type="text" placeholder="<?php echo __('Rank', 'sw_win'); ?>" /></th>
