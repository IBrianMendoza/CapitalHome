...
<h1><?php echo __('Locations','sw_win'); ?> 
    <a href="<?php echo admin_url("admin.php?page=treefield_locations&function=addvalue&field_id=".$field_id); ?>" class="page-title-action"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo __('Add New','sw_win')?></a>
    <a href="<?php echo admin_url("admin.php?page=treefield_locations&function=addvalue_from_svg&field_id=".$field_id); ?>" class="page-title-action"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo __('Add from SVG map','sw_win')?></a>
...
<?php if (sw_count($treefield_table)): foreach ($treefield_table as $item): ?>
                <tr>
                    ...
                    <td><?php echo btn_edit(admin_url("admin.php?page=treefield_locations&function=addvalue&id=".$item->idtreefield)) ?></td>
                    <td><?php echo btn_delete(admin_url("admin.php?page=treefield_locations&function=remvalue&id=".$item->idtreefield)); ?></td>
                </tr>
<?php endforeach; ?>
<?php else: ?>
                <tr>
