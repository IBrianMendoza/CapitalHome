...
<h1><?php echo __('Currency manage','sw_win'); ?> 
<a href="<?php menu_page_url( 'currency_manage', true ); ?>&amp;function=addcurrency" class="page-title-action"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo __('Add New','sw_win')?></a>
<a href="<?php menu_page_url( 'currency_manage', true ); ?>&amp;function=importeu" class="page-title-action"><i class="fa fa-refresh"></i>&nbsp;&nbsp;<?php echo __('Sync with EU bank','sw_win')?></a>
</h1>
		...
		<table id="din-table" class="table table-striped" style="width: 100%;">
			<thead>
				<tr>
					...
					<th data-priority="4"><?php echo __('Currency symbol', 'sw_win'); ?></th>
					<th data-priority="2"><?php echo __('Currency code', 'sw_win'); ?></th>
                    <th><?php echo __('Rate index', 'sw_win'); ?></th>
			...
			<tfoot>
				<tr>
					...
					<th><input type="text" placeholder="<?php echo __('Currency symbol', 'sw_win'); ?>" /></th>
                    <th><input type="text" placeholder="<?php echo __('Currency code', 'sw_win'); ?>" /></th>
					<th><input type="text" placeholder="<?php echo __('Rate index', 'sw_win'); ?>" /></th>
                    <th></th>
                    <th></th>
				</tr>
			</tfoot>
