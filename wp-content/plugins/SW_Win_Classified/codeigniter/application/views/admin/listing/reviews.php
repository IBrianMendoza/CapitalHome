...
<h1><?php echo __('Reviews','sw_win'); ?></h1>
		...
		<table id="din-table" class="table table-striped" style="width: 100%;">
			<thead>
				<tr>
                    ...
                    <th data-priority="5"><?php echo __('Listing ID', 'sw_win'); ?></th>
                    <th data-priority="4"><?php echo __('User ID', 'sw_win'); ?></th>
                    <th data-priority="3"><?php echo __('Stars', 'sw_win'); ?></th>
                    <th data-priority="2"><?php echo __('Edit', 'sw_win'); ?></th>
			...
			<tfoot>
				<tr>
                    ...
                    <th><input type="text" placeholder="<?php echo __('User ID', 'sw_win'); ?>" /></th>
                    <th><input type="text" placeholder="<?php echo __('Stars', 'sw_win'); ?>" /></th>
                    <th></th>
                    <th></th>
				</tr>
			</tfoot>
