...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    ...
    <div class="col-xs-12 col-sm-6">
      ...
      <div class="form-group <?php _has_error('date_rank_expire'); ?> IS-INPUTBOX">
        <label for="input_date_rank_expire" class="col-sm-3 control-label"><?php echo __('Date rank expire','sw_win'); ?></label>
        <div class="col-sm-9">
          <input name="date_rank_expire" value="<?php echo _fv('form_object', 'date_rank_expire'); ?>" type="text" id="input_date_rank_expire" class="form-control datetimepicker_1" placeholder="<?php echo __('Date rank expire','sw_win'); ?>"/>
        </div>
      </div>
      
      <div class="form-group <?php _has_error('repository_id'); ?>">
      ...
      <div class="form-group <?php _has_error('transition_id'); ?> IS-INPUTBOX">
        <label for="input_transition_id" class="col-sm-3 control-label"><?php echo __('Transition id','sw_win'); ?></label>
        <div class="col-sm-9">
          <input name="transition_id" value="<?php echo _fv('form_object', 'transition_id'); ?>" type="text" id="input_transition_id" class="form-control" placeholder="<?php echo __('Transition id','sw_win'); ?>"/>
        </div>
      </div>

      <div class="form-group <?php _has_error('rank'); ?> IS-INPUTBOX">
        <label for="input_rank" class="col-sm-3 control-label"><?php echo __('Rank id','sw_win'); ?></label>
        <div class="col-sm-9">
      ...
      <div class="form-group <?php _has_error('user_id'); ?>">
        ...
        <div class="col-sm-9">
            <?php echo form_multiselect('user_id[]', $agents, _fv('form_object', 'user_id', 'MULTISELECT', array_keys($agents)), 'class="form-control" id="user_id"')?>
            <div class="agent_add form-inline">
            <?php echo form_dropdown_ajax('agent_id', 'user_m', '', 'display_name', NULL);?>
            <button type="button" class="btn btn-primary add_button"><?php echo __('Add agent', 'sw_win'); ?></button>
      ...
      <div class="form-group <?php _has_error('is_featured'); ?>">
      ...
      <div class="col-xs-12 col-sm-6">
        ...
        <br/>
        <div class="clearfix">
            <a href="<?php echo esc_url(listing_url($form_object)); ?>" target="_blank" class="btn btn-default add_button pull-right"><?php echo __('Preview listing', 'sw_win'); ?></a>
            <a href="<?php echo admin_url("admin.php?page=listing_manage&function=clonelisting&listing_id="._fv('form_object', 'idlisting')); ?>" target="_blank" class="btn btn-default add_button pull-right" style="margin-right: 7px;"><?php echo __('Clone listing', 'sw_win'); ?></a>
        </div>
        <?php endif;?>
      </div>
      </div>
