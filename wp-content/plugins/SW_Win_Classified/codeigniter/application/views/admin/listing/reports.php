...
<h1><?php echo __('Reports','sw_win'); ?></h1>
		...
		<table id="din-table" class="table table-striped" style="width: 100%;">
			<thead>
				<tr>
                    ...
                    <th data-priority="5"><?php echo __('Name', 'sw_win'); ?></th>
					<th><?php echo __('Date', 'sw_win'); ?></th>
					<th style="width: 100% !important;"><?php echo __('Email', 'sw_win'); ?></th>
                    <th data-priority="4"><?php echo __('Message', 'sw_win'); ?></th>
					<th data-priority="2"><?php echo __('Listing ID', 'sw_win'); ?></th>
			...
			<tfoot>
				<tr>
                    ...
                    <th><input type="text" placeholder="<?php echo __('Name', 'sw_win'); ?>" /></th>
