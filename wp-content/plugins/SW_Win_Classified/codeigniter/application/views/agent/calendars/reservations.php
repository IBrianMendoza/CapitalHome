...
<h1><?php echo __('Calendar reservations','sw_win'); ?> <a href="<?php menu_page_url( 'owncalendars_reservations', true ); ?>&function=addreservation" class="page-title-action"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo __('Add New','sw_win')?></a>
</h1>
		...
		<table id="din-table" class="table table-striped" style="width: 100%;">
			<thead>
				<tr>
                    ...
                    <th><?php echo __('User', 'sw_win'); ?></th>
                    <th><?php echo __('Listing ID', 'sw_win'); ?></th>
					<th><?php echo __('From', 'sw_win'); ?></th>
                    <th><?php echo __('To', 'sw_win'); ?></th>
			...
			<tfoot>
				<tr>
					...
					<th><input type="text" placeholder="<?php echo __('From', 'sw_win'); ?>" /></th>
                    <th><input type="text" placeholder="<?php echo __('To', 'sw_win'); ?>" /></th>
                    <th></th>
                    <th></th>
				</tr>
			</tfoot>
	...
	if ($('#din-table').length) {
		...
		var table = $('#din-table').DataTable({
            ...
            'ajax': {
                ...
                "data": function ( d ) {
                    return $.extend( {}, d, {
                        "page": 'owncalendars_datatablereservation',
                        "action": 'ci_action'
                    } );
                }
            },
