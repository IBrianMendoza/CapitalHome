...
<h1><?php echo __('Calendar rates','sw_win'); ?> <a href="<?php menu_page_url( 'owncalendars_rates', true ); ?>&function=addrate" class="page-title-action"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo __('Add New','sw_win')?></a>
</h1>
	...
	if ($('#din-table').length) {
		...
		var table = $('#din-table').DataTable({
            ...
            'ajax': {
                ...
                "data": function ( d ) {
                    return $.extend( {}, d, {
                        "page": 'owncalendars_datatablerates',
                        "action": 'ci_action'
                    } );
                }
            },
