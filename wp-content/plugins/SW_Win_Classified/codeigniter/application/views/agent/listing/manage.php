...
<h1><?php echo __('Listing manage','sw_win'); ?> <a href="<?php menu_page_url( 'ownlisting_addlisting', true ); ?>" class="page-title-action"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo __('Add New','sw_win')?></a></h1>
