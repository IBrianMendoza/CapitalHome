...
<h1><?php echo __('Invoices','sw_win'); ?> </h1>

<div class="bootstrap-wrapper">

<?php if(function_exists('wc_get_page_permalink')): ?>
<div class="alert alert-info">
    <a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>"><?php echo __('WooCommerce Orders and Profile visible here', 'sw_win'); ?></a>
</div>
<?php endif; ?>
		...
		<table id="din-table" class="table table-striped" style="width: 100%;">
			<thead>
				<tr>
                    ...
                    <th><?php echo __('Num', 'sw_win'); ?></th>
					<th data-priority="4"><?php echo __('User', 'sw_win'); ?></th>
					<th data-priority="2"><?php echo __('Listing', 'sw_win'); ?></th>
                    <th data-priority="2"><?php echo __('Subscription', 'sw_win'); ?></th>
                    <th><?php echo __('Price', 'sw_win'); ?></th>
                    <th><?php echo __('Activated', 'sw_win'); ?></th>
                    <th data-priority="3"><?php echo __('View', 'sw_win'); ?></th>
				</tr>
			</thead>
			<tbody>
			...
			<tfoot>
				<tr>
                    ...
                    <th><input type="text" placeholder="<?php echo __('Num', 'sw_win'); ?>" /></th>
					<th><input type="text" placeholder="<?php echo __('User', 'sw_win'); ?>" /></th>
                    <th><input type="text" placeholder="<?php echo __('Listing', 'sw_win'); ?>" /></th>
                    <th><input type="text" placeholder="<?php echo __('Subscription', 'sw_win'); ?>" /></th>
					<th><input type="text" placeholder="<?php echo __('Price', 'sw_win'); ?>" /></th>
                    <th><input type="checkbox" placeholder="<?php echo __('Activated', 'sw_win'); ?>" /></th>
                    <th></th>
				</tr>
			</tfoot>
		</table>
	...
	if ($('#din-table').length) {
		...
		var table = $('#din-table').DataTable({
            ...
            'ajax': {
                ...
                "data": function ( d ) {
                    return $.extend( {}, d, {
                        "page": 'ownlisting_datatableinvoice',
                        "action": 'ci_action'
                    } );
                }
            },
