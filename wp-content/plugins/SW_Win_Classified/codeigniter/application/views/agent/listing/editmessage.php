...
<h1><?php echo __('Edit message','sw_win'); ?> </h1>
<?php else: ?>
    ...
    <div class="messages-section load-box">
        ...
        <div class="send-box">
            <form action="" id="message-form">
                ...
                <input type="hidden" id="user_id_sender" name='user_id_sender' readonly value="<?php echo $current_user_id; ?>">
                <input type="hidden" id="user_id_receiver" name='user_id_receiver' readonly value="<?php echo $live_user_id_receiver; ?>">
                <input type="hidden" id="email_receiver" name='email_receiver' readonly value="<?php echo $live_emailreceiver; ?>">
                <input type="hidden" id="email_sender" name='email_sender' readonly value="<?php echo $live_emailsender; ?>">
