...
<h1><?php echo __('Favorites','sw_win'); ?></h1>
		...
		<table id="din-table" class="table table-striped" style="width: 100%;">
			<thead>
				<tr>
                    ...
                    <th data-priority="5"><?php echo __('User ID', 'sw_win'); ?></th>
                    <th data-priority="3"><?php echo __('Open', 'sw_win'); ?></th>
	...
	if ($('#din-table').length) {
		...
		var table = $('#din-table').DataTable({
            ...
            'ajax': {
                ...
                "data": function ( d ) {
                    return $.extend( {}, d, {
                        "page": 'ownlisting_datatablefavorites',
                        "action": 'ci_action'
                    } );
                }
            },
