...
<h1><?php echo __('Save Search','sw_win'); ?></h1>
		...
		<table id="din-table" class="table table-striped" style="width: 100%;">
			<thead>
				<tr>
                    ...
                    <th data-priority="5"><?php echo __('User', 'sw_win'); ?></th>
					<th><?php echo __('Date', 'sw_win'); ?></th>
					<th style="width: 100% !important;"><?php echo __('Is activated', 'sw_win'); ?></th>
                    <th data-priority="4"><?php echo __('Date informed', 'sw_win'); ?></th>
			...
			<tfoot>
				<tr>
                    ...
                    <th><input type="checkbox" placeholder="<?php echo __('Is activated', 'sw_win'); ?>" /></th>
					<th><input type="text" placeholder="<?php echo __('Date informed', 'sw_win'); ?>" /></th>
                    <th></th>
                    <th></th>
				</tr>
			</tfoot>
	...
	if ($('#din-table').length) {
		...
		var table = $('#din-table').DataTable({
            ...
            'ajax': {
                ...
                "data": function ( d ) {
                    return $.extend( {}, d, {
                        "page": 'ownlisting_datatablesavesearch',
                        "action": 'ci_action'
                    } );
                }
            },
