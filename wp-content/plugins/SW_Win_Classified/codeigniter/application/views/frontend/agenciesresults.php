<div id="results-agencies" >

<span id="results_top"></span>

<?php if($agencies_count == 0): ?>

<div class="row">
    <div class="col-xs-12">
    <div class="alert alert-info" role="alert"><?php echo __('Agency not found', 'sw_win'); ?></div>
    </div>
</div>
...
<?php foreach($agencies as $key=>$user_details): 
