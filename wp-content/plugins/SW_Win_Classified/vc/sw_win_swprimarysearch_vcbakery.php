...
add_action( 'vc_before_init', 'Swprimarysearch_VC' );
function Swprimarysearch_VC() {
    if (class_exists('WPBakeryShortCode')) {
        vc_map( array(
        	'name' => __( 'SW Primary Search', 'sw_win' ),
        	'base' => 'Swprimarysearch',
        //	'icon' => 'icon-wpb-ui-separator',
        	'show_settings_on_create' => false,
        	'category' => __( 'Content', 'sw_win' ),
        //"controls"	=> 'popup_delete',
        	'description' => __( 'Primary search form', 'sw_win' ),
        	'params' => array(
//        		array(
//        			'type' => 'textfield',
...
//        		)
        ...
        class WPBakeryShortCode_Swprimarysearch extends WPBakeryShortCode {
...
//                if(empty($atts['radius']))$atts['radius'] = 2000;
                ...
                $output.= do_shortcode('[swprimarysearch id="'.$atts['id'].'" ]');
